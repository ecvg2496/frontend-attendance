...
function Cover() {
    ...
    const termslogin = (
  <MDBox mt={isMobile ? 1 : 3}>
    <MDBox display="flex" justifyContent="center" mb={isMobile ? 1 : 2}>
      <MDTypography 
        variant="h4" 
        fontWeight="bold" 
        color="info" 
    ...
    <MDBox sx={{ 
      ...
      <MDTypography paragraph sx={{ fontSize: "inherit" }} mt={isMobile ? -1 : -3}>
      ...
      <MDBox component="ul" sx={{ pl: isMobile ? 2 : 3 }}>
        <MDBox component="li" sx={{ ml: isMobile ? 1 : 2, fontSize: "inherit" }}>
