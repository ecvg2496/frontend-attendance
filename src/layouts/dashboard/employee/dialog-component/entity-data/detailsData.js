export default [
    ...
    },
    {
        ...
        type: 'check',
        required: true,
        options: ['SSS ID', 'PHIC ID', 'HDMF ID', 'BIR 2316 (previous employer)', 'Birth Certificate (preferably PSA)', '2x2 picture with white background (for ID purposes)',
            'Certificate of Employment (most recent employer)', 'TOR', 'None of the Above'
        ],
    },
